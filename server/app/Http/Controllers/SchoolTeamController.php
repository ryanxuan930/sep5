...
class SchoolTeamController extends Controller
{
    ...
    {
        $this->middleware('auth:admin', ['except' => ['index', 'indexAll', 'show']]);
    }
    /**
