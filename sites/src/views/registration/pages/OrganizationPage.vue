...
async function getData() {
  await vr.Get(`organization/${store.userInfo.org_code}`, orgData, true, true);
  if (orgData.value !== null || orgData.value.value > 0) {
    Object.keys(data).forEach((index: string) => {
      data[index] = orgData.value[index];
    })
  }
}
getData();
...
function submitAll() {
  ...
  if (orgData.value === null) {
    ...
    vr.Patch(`organization/${orgData.value.org_code}`, temp, null, true, true).then( (res: any) => {
      if (res.status !== 'A01') {
        alert('無法儲存');
        return;
      }
...
<template>
  <SpinnerLoading v-show="orgData == null"></SpinnerLoading>
  <div class="main-box grid grid-cols-1 md:grid-cols-4 gap-3 shadow-inner p-2" v-if="orgData != null">
    ...
    <label class="round-input-label md:col-span-2">
      ...
      <input class="input" :disabled="!isEdit" type="text" v-model="data.org_name_full_ch">
    </label>
    <label class="round-input-label md:col-span-2">
      <div class="title">{{ t('org-name-ch') }}*</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.org_name_ch">
    </label>
    <label class="round-input-label md:col-span-2">
      <div class="title">{{ t('org-name-full-en') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.org_name_full_en">
    </label>
    <label class="round-input-label md:col-span-2">
      <div class="title">{{ t('org-name-en') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.org_name_en">
    </label>
    <label class="round-input-label">
      <div class="title">{{ t('org-code') }}</div>
      <div class="input disabled">{{ orgData.org_code }}</div>
    </label>
    <label class="round-input-label">
    ...
    <div class="md:col-span-3 flex gap-3">
      <label class="round-input-label basis-1/4">
        ...
        <input class="input" :disabled="!isEdit" type="text" v-model="data.zipcode">
      </label>
    ...
    <div class="md:col-span-2 flex gap-3">
      <label class="round-input-label basis-3/4">
        ...
        <input class="input" :disabled="!isEdit" type="text" v-model="data.telephone">
      </label>
      <label class="round-input-label basis-1/4">
        <div class="title">{{ t('ex') }}</div>
        <input class="input" :disabled="!isEdit" type="text" v-model="data.telephone_ex">
      </label>
    </div>
    <label class="round-input-label">
      <div class="title">{{ t('fax') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.fax">
    </label>
    <label class="round-input-label">
      <div class="title">{{ t('homepage') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.homepage">
    </label>
    <label class="round-input-label">
      <div class="title">{{ t('contact') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.contact_name">
    </label>
    <label class="round-input-label">
      <div class="title">{{ t('contact-phone') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.contact_phone">
    </label>
    <label class="round-input-label md:col-span-2">
      <div class="title">{{ t('contact-email') }}</div>
      <input class="input" :disabled="!isEdit" type="text" v-model="data.contact_email">
    </label>
    ...
    <div class="flex flex-col gap-3">
      <label class="round-input-label">
        ...
        <input class="input" :disabled="!isEdit" type="text" v-model="data.chairman_ch">
      </label>
      <label class="round-input-label">
        <div class="title">{{ t('english-name') }}</div>
        <input class="input" :disabled="!isEdit" type="text" v-model="data.chairman_en">
      </label>
    </div>
    <div class="round-input-label md:row-span-2">
    ...
    <div class="flex flex-col gap-3">
      <label class="round-input-label">
        <div class="title">{{ t('chinese-name') }}</div>
        <input class="input" :disabled="!isEdit" type="text" v-model="data.leader_ch">
      </label>
      <label class="round-input-label">
        <div class="title">{{ t('english-name') }}</div>
        <input class="input" :disabled="!isEdit" type="text" v-model="data.leader_en">
      </label>
    </div>
