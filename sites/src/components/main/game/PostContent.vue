...
<template>
  <div v-if="data != null">
    <div @click="$router.push(`/${$route.params.adminOrgId}/game/${$route.params.gameId}/news`)" class="py-5 text-left text-gray-500 hover:text-gray-400 duration-200 cursor-pointer text-xl inline-block">{{ t('back') }}</div>
