  ...
  <div class="h-full overflow-auto grid grid-cols-1 md:grid-cols-4 gap-3 shadow-inner p-2">
    ...
    <label class="round-input-label" v-if="data.org_code.substring(0, 1) !== 'O'">
      ...
      <select class="select" v-model="data.grade" :disabled="data.is_student == 0 || Config.deptAsClass == true" >
        ...
        <option value="21">大一 B.S. 1</option>
        <option value="22">大二 B.S. 2</option>
        <option value="23">大三 B.S. 3</option>
        <option value="24">大四 B.S. 4</option>
        <option value="25">大五 B.S. 5</option>
        <option value="26">大六 B.S. 6</option>
        <option value="27">大七 B.S. 7</option>
        <option value="28">大八 B.S. 8</option>
        <option value="31">碩一 M.S. 1</option>
        <option value="32">碩二 M.S. 2</option>
        <option value="33">碩三 M.S. 3</option>
        <option value="34">碩四 M.S. 4</option>
