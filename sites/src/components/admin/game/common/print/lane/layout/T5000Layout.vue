    ...
    <template v-for="(data, index) in dataList" :key="index">
      <table class="result-table">
        <tr>
          ...
          <th rowspan="2" class="text-center">0</th>
          <th rowspan="2">
        ...
        <template v-for="(item, index) in data.data" :key="index">
          <tr v-if="item[`r${[round]}_heat`] > 0 && item[`r${[round]}_lane`] > 0">
            ...
            <td rowspan="2" style="width: 4%">{{ item[`r${[round]}_heat`] }}</td>
            <td rowspan="2" style="width: 4%">{{ item[`r${[round]}_lane`] }}</td>
            ...
            <td rowspan="2" style="width: 10%">{{ item[`${props.lastRound}_result`] }}</td>
            <template v-for="item in 6">
              <td style="width: 3%;"></td>
            </template>
            <td rowspan="2" style="width: 3%"></td>
            <td rowspan="2" style="width: 10%; padding: 0;" class="h-1">
